...
class Mailbox {
    ...
    async processNew(messageData, options, canSync, storedStatus) {
        ...
        if (!shouldProcessMessage) {
            ...
            this.logger.debug({ msg: 'Skipping message - not part of tracked threads', uid: messageData.uid, messageId: messageInfo.messageId , account: this.connection.account});
            return;
        }
