...
// Use global Sentry instance from the worker thread
// This is initialized in workers/imap.js and made available globally
...
class BaseClient {
    ...
    async processNew(messageData, options) {
        // Wrap the entire function with Sentry span tracking
        if (!Sentry) {
            // If Sentry is not initialized, proceed without tracking
            return this._processNewInternal(messageData, options);
        }

        return await Sentry.startSpan(
            {
                name: 'BaseClient.processNew',
                attributes: {
                    account: this.account,
     ...
     * @private
     */
    async _processNewInternal(messageData, options) {
